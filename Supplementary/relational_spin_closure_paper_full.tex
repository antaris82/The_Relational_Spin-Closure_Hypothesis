...
% ======================================================================
% SUPERSEDED / WITHDRAWN VERSION
% This source is retained only for historical provenance.
% Do not cite or use it as the current mathematical paper.
% Current paper:
% https://raw.githubusercontent.com/antaris82/The_Relational_Spin-Closure_Hypothesis/main/docs/mathematics/A_Conditional_Construction_of_Lorentzian_Geometry.pdf
% ======================================================================
% ======================================================================
...
\usepackage[
  hidelinks,
  pdftitle={SUPERSEDED - The Relational Spin-Closure Hypothesis: From Euclidean Three-Space to Conditional Lorentzian Spin Geometry},
  pdfauthor={Jan Seeck (Editor)},
  pdfsubject={SUPERSEDED / WITHDRAWN VERSION. Retained only for historical provenance; see the current mathematical paper linked on the title page.}
]{hyperref}
...
\large From Euclidean Three-Space to Conditional Lorentzian Spin Geometry\\[0.9em]
\Large\color{red!75!black}SUPERSEDED / WITHDRAWN VERSION}
...
\fcolorbox{red!75!black}{red!4}{%
\begin{minipage}{0.90\textwidth}
\centering
{\Large\bfseries\color{red!75!black}THIS PAPER HAS BEEN SUPERSEDED}\par\medskip
{\bfseries This version is withdrawn as the current mathematical presentation and is retained only for historical provenance.}\par\medskip
Do not cite or use this document as the current statement of the mathematics.\par\medskip
\textbf{Current paper:}\par
\href{https://raw.githubusercontent.com/antaris82/The_Relational_Spin-Closure_Hypothesis/main/docs/mathematics/A_Conditional_Construction_of_Lorentzian_Geometry.pdf}{\nolinkurl{https://raw.githubusercontent.com/antaris82/The_Relational_Spin-Closure_Hypothesis/main/docs/mathematics/A_Conditional_Construction_of_Lorentzian_Geometry.pdf}}
\end{minipage}%
}
\end{center}
\vspace{1em}
...
\begin{abstract}
\textbf{Superseded version.} The mathematical presentation below has been replaced by the current paper linked above and is preserved only as an archival record.\par\medskip
